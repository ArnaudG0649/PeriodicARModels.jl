...
"""
function SimulateScenarios(x0::AbstractArray, Date_vec::AbstractVector, Φ, σ::AbstractVector{T}, nspart=0, σ_nspart=1; rng=Random.default_rng(), correction="null", return_res=false) where T<:AbstractFloat
    p = length(x0)
